...
def forwards_encrypted_nullable_integer(apps, schema_editor):
    EncryptedNullableIntegerModel = apps.get_model('fields', 'EncryptedNullableIntegerModel')
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunPython(forwards_encrypted_nullable_integer, reverse_encrypted_nullable_integer),
        migrations.RunPython(forwards_encrypted_ttl_integer, reverse_encrypted_ttl_integer),
        migrations.RunPython(forwards_other_encrypted_types, reverse_other_encrypted_types),
    ]
