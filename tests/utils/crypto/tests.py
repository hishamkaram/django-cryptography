...
from django.utils.crypto import pbkdf2 as django_pbkdf2, salted_hmac as django_salted_hmac
...
class TestUtilsCryptoPBKDF2(unittest.TestCase):
    ...
    def test_defaults(self):
        ...
        self.assertEqual('0c60c80f961f0e71f3a9b524af6012062fe037a6', binascii.hexlify(result).decode('ascii'))
    ...
    def test_django_parity(self):
        for vector in self.rfc_vectors:
            self.assertEqual(pbkdf2(**vector['args']), django_pbkdf2(**self.django_args(vector['args'])))
...
class FernetBytesTestCase(unittest.TestCase):
    ...
    def test_encrypt_decrypt(self):
        ...
        with freeze_time(123456789):
            fernet = FernetBytes()
            self.assertEqual(fernet._encrypt_from_parts(value, iv), binascii.unhexlify(data))
...
class StandardFernetTestCase(unittest.TestCase):
    def test_encrypt_decrypt(self):
        ...
        iv = b'0123456789abcdef'
        data = (
            b'gAAAAAAdwJ6wMDEyMzQ1Njc4OWFiY2RlZjYYKxzJY4VTm9YIi4' b'Pp6o_RvhRbEt-VW6a0zE-ys6tS1_2Xd2011mjXrVrMV0QfRA=='
        )
